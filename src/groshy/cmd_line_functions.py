...
def write_recipe(fp: str = "None") -> Recipe:
    ...
    recd["description"] = _ask_field("description", False, "Please provide a \
...
by pressing the enter key when done writing each step."""))
    ...
    recd["category"] = _ask_field("category", False, "What category of food \
is this recipe?: ")

    recd["cuisine"] = _ask_field("cuisine", False, "What type of cuisine \
is this recipe?: ")

    recd["yields"] = _ask_field("yields", False, "How many servings \
does this recipe yield?: ")

    recd["cooking_time"] = int(_ask_field("cooking_time", False, """How long 
